...
class CTCNetModel(BaseModel):
    ...
    def forward(self):
        self.img_SR_coarse, self.img_SR = self.netG(self.img_LR) 

    def backward_G(self):
        # Pix loss
        self.loss_Pix = self.criterionL1(self.img_SR, self.img_HR) * self.opt.lambda_pix+self.criterionL1(self.img_SR_coarse, self.img_HR) * 0.2
