...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--save_iter_freq', type=int, default=2000, help='frequency of saving the models')
        parser.add_argument('--save_latest_freq', type=int, default=2000, help='save latest freq')
